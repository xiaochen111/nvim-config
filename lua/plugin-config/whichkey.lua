...
local mappings = {
  ...
  g = {
    ...
    f = { "<cmd>DiffviewFileHistory<CR>", "File History 文件历史 --space-hd另一种展示" },
    p = { "<cmd>DiffviewOpen<CR>", "Diff Project" },
    n = { "<cmd>lua require 'gitsigns'.next_hunk()<cr>", "Next Hunk git修改的地方--space-j" },
    N = { "<cmd>lua require 'gitsigns'.prev_hunk()<cr>", "Prev Hunk git修改的地方--space-k" },
    l = { "<cmd>lua require 'gitsigns'.blame_line()<cr>", "Blame" },
    r = { "<cmd>lua require 'gitsigns'.reset_hunk()<cr>", "Reset Hunk 重置光标所在的git修改--space-hr" },
    h = { "<cmd>lua require 'gitsigns'.preview_hunk()<cr>", "Preview Buffer 鼠标悬浮查看更改变化" },
